...
def get_face_by_RetinaFace(facea, inimg, mobile_net, resnet_net, device, kf = None,kf_driving = None):
    ...
    for r_idx in range(len(padding_ratio)):
        ...
        #     previous_model = previous_model + 1
        #     # print("New_model_used")
        #     l_coordinate, check_fail = detect_faces_retinaface_tensor(inimg, ratio = padding_ratio[r_idx])
        #     if check_fail and r_idx == len(padding_ratio)-1:
        #         count_loss_detect = count_loss_detect+ 1
        ...
        #         continue
                #print(results)
                #    l_coordinate = results['face_1']['facial_area']
        face_landmarks = None
        bbox = None
...
if __name__ == "__main__":
    ...
    model_Occ.eval()
    # FRAME_PATH = 'in.mp4'
    # FACE_PATH = '/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/Dr_video/3sourceheadMovCSV_27July_Dr_ES_newdriving_gfpgan2.mp4'
    ...
    output_path = '/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/Dr_video/1Aug_Dr_ES_full_newlogicgfpgan.mp4'
            ...
            if not count_frame in List_speak_frame:
                ...
                if videopts is None or facepts is None :
                    ...
                    try:
                        ...
                        if m_topy <2 or m_topx <2 or m_bottomy > int(height_)-2 or m_bottomx > int(width_)-2 or newval < 0.8902 or (newval < 0.83 and face_angle != 0):
