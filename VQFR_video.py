...
from VQFR.vqfr.demo_util import VQFR_Demo
# import tqdm
...
if __name__ == "__main__":
    ...
    ACTIVATION = None
    DEVICE = 'cuda:0'
    # FRAME_PATH = '/home/ubuntu/first-order-model/3sourceheadMovCSV_23Aug_Dr_ES.mp4'
    FRAME_PATH = "/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/result_4p18_4p28.mp4"
    # FRAME_PATH = '/home/ubuntu/quyennv/DeepFake/out_new_sources.mp4'
    ...
    encoder_video = ffmpeg_encoder('result_4p18_4p28_vqfr.mp4', fps, int(width_)*scale, int(height_)*scale)
    # encoder_video = ffmpeg_encoder('/home/ubuntu/quyennv/DeepFake/out_new_sources_gfpgan.mp4', fps, int(width_)*scale, int(height_)*scale)
    ...
    while capFrame.isOpened():
        ...
        if count_frame < frame_start:
            ...
            # else:
            #     # print("Frame:", count_frame, "Not speak")
