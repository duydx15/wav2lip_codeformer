...
if __name__ == "__main__":
    ...
    FRAME_PATH = "/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/Dr_dst.mp4"
    ...
    encoder_video = ffmpeg_encoder('Dr_video/Dr_dst_gfpgan.mp4', fps, int(width_)*scale, int(height_)*scale)
