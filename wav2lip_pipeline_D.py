...
def main():
    vidpath = '/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/DFLive_test/keanue/keanu.mp4'#_wav2lip/DrDisrespect-Falls-in-Love-with-Warzone-again-thanks-to-new-Game-Mode-30FPS.mp4'
    frame_path = '/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/DFLive_test/keanue/keanu.mp4'
    #'Dr_video/DrDisrespect-Falls-in-Love-with-Warzone-again-thanks-to-new-Game-Mode-30FPS.mp4'
    savepath = '/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/DFLive_test/keanue/Wav2lipgan_keanue_lipsync.mp4'
    ...
    for i in tqdm(range(total_output_frames)):
        ...
        # elif count_frame == 10023:
            ...
            # else:
            res = lipsync_one_frame(frame,frame_ori, mel_chunk, facemesh, MASK_KP_IDS,  wav2lip_model, mobile_net_wav2lip, resnet_net_wav2lip, device,to_tensor,model_Occ,sfd_facedetector)
