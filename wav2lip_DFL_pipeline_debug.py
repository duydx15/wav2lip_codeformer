...
def get_keypoint_mouth(input_img,face_landmarks,bbox,kf_mouth=None,kf=None,kf_68=None):
    with open("/home/ubuntu/Documents/wav2lip_codeformer/_wav2lip/config_lipsync_wav2lip.json",'r') as f_lips:
...
def main():
    ...
    for i in tqdm(range(int(total_output_frames))):
        ...
        #     break
    # del all models
    del  facemesh, wav2lip_model, mel_chunks, mobile_net_wav2lip, resnet_net_wav2lip
    # release
    cap.release()
    cap_ori.release()
...
if __name__=='__main__':
    ...
    logging.basicConfig(filename=f'/home/ubuntu/Documents/wav2lip_codeformer/logs/wav2lip-{date}.log',filemode = 'w', level=logging.INFO,format='%(asctime)s - %(levelname)s- %(message)s')
    main()
